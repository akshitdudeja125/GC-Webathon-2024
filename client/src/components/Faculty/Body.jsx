  ...
  return (
    <div className="flex-[0.8] mt-3">
      <div className="space-y-5">
        <div className="flex text-gray-400 items-center space-x-2 overflow-auto">
          <HomeIcon />
          <h1>Dashboard</h1>
        </div>
        <div className="flex flex-col mr-5 space-y-4 overflow-y-auto">
          <div className="bg-white h-[8rem] rounded-xl shadow-lg grid grid-cols-4 justify-between px-8 items-center space-x-4 ml-10 mr-10">
          ...
          <div className="flex space-x-4 ml-10">
            ...
            <div className="bg-white h-[17rem] w-full rounded-xl shadow-lg flex flex-col  pt-3 ml-10 mr-10">
